...
public class MenuEstudianteAdapter extends RecyclerView.Adapter<MenuEstudianteAdapter.ViewHolder> {

    Context mContext;
    OnItemClickListener mItemClickListener;
    ArrayList<Menu> listData = new MenuDatos().placeListEstudiante();

    public MenuEstudianteAdapter(Context context) {
    ...
    public int getItemCount() {
        return new MenuDatos().placeListEstudiante().size();
    }
