...
public class EstudianteControlador {
    ...
    public boolean guardarImagen(
        ...
        map.put("ESTCODIGO", ESTCODIGO);
        map.put("EJEIMAGEN", EJEIMAGEN);
        map.put("EJENOMBRE", EJENOMBRE);
        map.put("EJEDESCRIPCION", EJEDESCRIPCION);
    ...
    public void actualizarPago(String ESTCODIGO,String PAGTIPOPAGO,
        ...
        map.put("ESTCODIGO", ESTCODIGO);
        map.put("PAGTIPOPAGO", PAGTIPOPAGO);
        map.put("PAGMONTO", PAGMONTO);
        map.put("PAGUSUARIO", PAGUSUARIO);
        map.put("PAGTIPOUSUARIO", PAGTIPOUSUARIO);
