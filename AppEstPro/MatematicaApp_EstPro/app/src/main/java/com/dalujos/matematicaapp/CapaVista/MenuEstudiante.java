...
import com.dalujos.matematicaapp.Adapter.MenuEstudianteAdapter;
...
public class MenuEstudiante extends AppCompatActivity {
    ...
    private MenuEstudianteAdapter mAdapter;
    ...
    private void cargarRecyclerView(){
        ...
        mAdapter = new MenuEstudianteAdapter(this);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.navigation_item_1:
                        ...
                        et.setTextSize(20f);
                        et.setText("Aplicación Estudiante, en donde podrás resolver tus dudas matemáticas!");
    ...
    private void abrirReto(int opcion){
        ...
        switch (opcion){
            case 0:
                i = new Intent(MenuEstudiante.this, EnviarEjercicioVista.class);
                break;
            case 1:
                i = new Intent(MenuEstudiante.this, ListarEjercicioVista.class);
                i.putExtra("Tipo", "Estudiante");
                break;
            case 2:
                i = new Intent(MenuEstudiante.this, CambiarClaveVista.class);
                break;
            default:
                i = new Intent(MenuEstudiante.this, CambiarClaveVista.class);
                break;
    ...
    MenuEstudianteAdapter.OnItemClickListener onItemClickListener = new MenuEstudianteAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(View v, int position) {
            ...
            if(position == 3)
                ...
                nivel=""+(position+1);
            subtitulo = MenuDatos.placeNameArrayEstudiante[position];
