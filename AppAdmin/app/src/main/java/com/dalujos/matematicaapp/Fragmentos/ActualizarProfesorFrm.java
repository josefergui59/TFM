 ...
 */
public class ActualizarProfesorFrm extends Fragment {
    /*
    Etiqueta de depuración
     */
    private static final String TAG = ActualizarProfesorFrm.class.getSimpleName();
    ...
    */
    ...
    public ActualizarProfesorFrm() {

    }


    public static Fragment createInstance(String extra) {
        ActualizarProfesorFrm detailFragment = new ActualizarProfesorFrm();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textNombre = (TextView) v.findViewById(R.id.textView);
        textNombre.setText("Nombre Profesor");
        ...
        profesorModelo = new ProfesorModelo(getActivity());
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int intValidacion = profesorModelo.comprobarDatos("0", ESTFECHACREACION, ESTLOGIN, ESTCLAVE,
                ...
                if (intValidacion == 1 || intValidacion == 2) {
                    ...
                    profesorModelo.actualizarDatos(ESTNOMBRE ,
                            ESTCLAVE,
                            ESTLOGIN,
                            ESTFECHANAC ,
                            ESTFECHACREACION  ,
    ...
    private void cargarDatos() {
        ...
        String newURL = Conexion.GET_BY_ID_PRO + "?id=" + idRegistro;
        ...
        try {
            ...
            switch (estado) {
                case "1":
                    ...
                    // Guardar instancia
                    profesor = gson.fromJson(meta.toString(), Profesor.class);
    ...
    private void cargarDatosProfesor(Profesor estudiante) {
        // Cargar valores
        nomEstudiante.setText(estudiante.getPRONOMBRE());
        logIn.setText(estudiante.getPROLOGIN());
        fecha_text.setText(estudiante.getPROFECHANAC());
        clave.setText(estudiante.getPROCLAVE());
        txtIdentifica.setText(estudiante.getPROIDENTIFICA());
        txtCorreo.setText(estudiante.getPROCORREO());
        if (estudiante.getPROGENERO().equals("Masculino"))
    ...
    public void mensajeEliminar(String titulo, String mensaje){
        ...
        builder.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                profesorModelo.eliminarProfesor(idRegistro);
