...
public class ListarEstudianteFrm extends Fragment {


    private static final String TAG = ListarEstudianteFrm.class.getSimpleName();
    ...
    public ListarEstudianteFrm(String tipo) {
        this.tipo = tipo;
    }
        ...
        try {
            ...
            switch (estado) {
                case "1": // EXITO
                    ...
                    adapter = new AdaptadorEstudiante(Arrays.asList(estudiante), getActivity(), tipo);
