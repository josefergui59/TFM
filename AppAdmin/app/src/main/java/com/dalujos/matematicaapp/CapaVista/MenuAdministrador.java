...
import com.dalujos.matematicaapp.Adapter.TravelListAdapter;
...
public class MenuAdministrador extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.navigation_item_1:
                        ...
                        et.setTextSize(20f);
                        et.setText("Aplicación Administrador, en donde se pueden registrar créditos, agregar alumnos y profesores!");
    ...
    private void abrirReto(int opcion){
        ...
        switch (opcion){
            case 0:
                i = new Intent(MenuAdministrador.this, IngresoEstudianteVista.class);
                break;
            case 1:
                i = new Intent(MenuAdministrador.this, ListarEstudianteVista.class);
                i.putExtra("Tipo", "Estudiante");
                break;
            case 2:
                i = new Intent(MenuAdministrador.this, IngresoProfesorVista.class);
                break;
            case 3:
                i = new Intent(MenuAdministrador.this, ListarProfesorVista.class);
                i.putExtra("Tipo", "Profesor");
                break;
            case 4:
                i = new Intent(MenuAdministrador.this, CreditoEstudianteVista.class);
                //i.putExtra("Tipo", "Credito");
                break;
            default:
                i = new Intent(MenuAdministrador.this, IngresoEstudianteVista.class);
                break;
    ...
    TravelListAdapter.OnItemClickListener onItemClickListener = new TravelListAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View v, int position) {
            ...
            if(position == 3)
                ...
                nivel=""+(position+1);
            subtitulo = MenuDatos.placeNameArray[position];
