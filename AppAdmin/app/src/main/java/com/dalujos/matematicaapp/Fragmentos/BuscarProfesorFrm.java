...
import com.dalujos.matematicaapp.CapaVista.ActualizarProfesorVista;
 ...
 */
public class BuscarProfesorFrm extends Fragment {

    /**
     * Etiqueta de depuración
     */
    private static final String TAG = BuscarProfesorFrm.class.getSimpleName();
    ...
    public BuscarProfesorFrm() {
    }

    public static BuscarProfesorFrm createInstance(String idMeta, String tipo) {
        BuscarProfesorFrm detailFragment = new BuscarProfesorFrm();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView txtEjer = (TextView) v.findViewById(R.id.monederoEtiq);
        txtEjer.setText("Ejercicios Resueltos");
        ...
        editButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(getActivity(), ActualizarProfesorVista.class);
    ...
    public void cargarDatos() {
        ...
        String newURL = Conexion.GET_BY_ID_PRO + "?id=" + extra;
        ...
        try {
            ...
            switch (mensaje) {
                case "1":
                    ...
                    //Parsear objeto 
                    Profesor profesor = gson.fromJson(object.toString(), Profesor.class);

                    // Seteando valores en los views
                    nombre.setText(profesor.getPRONOMBRE());
                    fecha.setText(profesor.getPROFECHANAC());
                    genero.setText(profesor.getPROGENERO());
                    logIn.setText(profesor.getPROLOGIN());
                    clave.setText(profesor.getPROCLAVE());
                    monedero.setText(profesor.getPROEJERCICIORES());
                    id.setText(profesor.getPROIDENTIFICA());
                    correo.setText(profesor.getPROCORREO());
