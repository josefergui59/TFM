...
public class ActualizarEstudianteVista extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, ActualizarEstudianteFrm.createInstance(extra), "UpdateFragment")
                    .commit();
        }
    }
    ...
    public void onDateSelected(int year, int month, int day) {
        ActualizarEstudianteFrm updateFragment = (ActualizarEstudianteFrm)
